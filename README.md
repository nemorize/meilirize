...
Meilirize is a self-hosted mailbox backed by email APIs.

It is designed to turn provider APIs and webhooks into:

- A mailbox that can send and receive email
- SMTP, IMAP, and POP access
